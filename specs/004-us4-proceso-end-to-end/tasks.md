...
- [X] T063 [US4] Responsive testing: Verify diagram and walkthrough work on mobile (320px width)
- [X] T064 [US4] Final Lighthouse run: Verify all scores (Performance, Accessibility, Best Practices, SEO)
